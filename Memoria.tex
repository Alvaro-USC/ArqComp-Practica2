...
\begin{itemize}
  ...
  \item \textbf{v3\texttt{-O3} (32T):} $25{,}9\times$ ($n{=}1250$),
        ...
        de Jacobi es altamente paralelizable (\textit{embarrassingly parallel}).
\end{itemize}
% AUTO_G2_TEXT_END
...
\begin{itemize}
  ...
  \item Con 32~hilos la aceleración alcanza $25{,}4\times$ ($n{=}1250$ y
        $n{=}3200$) y $29{,}3\times$ ($n{=}2000$), mostrando una eficiencia
        del 79--91\,\%.
\end{itemize}
